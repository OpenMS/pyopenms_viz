(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ce21017c-9b4d-4b98-b426-b58949f25ac8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ce21017c-9b4d-4b98-b426-b58949f25ac8' but no matching script tag was found.")
        }
