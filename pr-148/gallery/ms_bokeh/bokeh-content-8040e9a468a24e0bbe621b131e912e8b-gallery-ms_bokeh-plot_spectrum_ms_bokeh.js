(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4272794-d19c-4b85-a6c0-1e8867090508");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4272794-d19c-4b85-a6c0-1e8867090508' but no matching script tag was found.")
        }
