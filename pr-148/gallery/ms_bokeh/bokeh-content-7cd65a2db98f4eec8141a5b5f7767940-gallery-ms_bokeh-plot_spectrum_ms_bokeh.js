(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a9b89e02-da4d-45d5-ba6c-67003cacffce");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a9b89e02-da4d-45d5-ba6c-67003cacffce' but no matching script tag was found.")
        }
