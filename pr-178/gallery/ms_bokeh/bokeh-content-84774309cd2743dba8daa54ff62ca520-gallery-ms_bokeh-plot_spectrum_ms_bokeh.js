(function() {
  const fn = function() {
    ...
    const element = document.getElementById("defbc997-4598-4169-b396-42fa6508857d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'defbc997-4598-4169-b396-42fa6508857d' but no matching script tag was found.")
        }
