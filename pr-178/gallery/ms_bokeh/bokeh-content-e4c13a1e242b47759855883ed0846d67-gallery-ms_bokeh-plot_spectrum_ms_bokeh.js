(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e505c28d-2f40-4b81-ba2e-fc9ae9790066");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e505c28d-2f40-4b81-ba2e-fc9ae9790066' but no matching script tag was found.")
        }
