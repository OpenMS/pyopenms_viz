(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db59303b-3b64-4b38-bee3-36e246e293d5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db59303b-3b64-4b38-bee3-36e246e293d5' but no matching script tag was found.")
        }
