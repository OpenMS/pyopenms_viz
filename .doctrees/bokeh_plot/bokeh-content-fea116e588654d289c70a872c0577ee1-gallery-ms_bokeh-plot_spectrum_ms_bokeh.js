(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c15d5634-f74b-4458-b5bf-0165eeaf37a2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c15d5634-f74b-4458-b5bf-0165eeaf37a2' but no matching script tag was found.")
        }
