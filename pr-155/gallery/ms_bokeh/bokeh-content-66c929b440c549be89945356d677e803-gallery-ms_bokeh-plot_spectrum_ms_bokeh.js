(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de09fcce-a510-42de-be6f-c0c987f66d26");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de09fcce-a510-42de-be6f-c0c987f66d26' but no matching script tag was found.")
        }
