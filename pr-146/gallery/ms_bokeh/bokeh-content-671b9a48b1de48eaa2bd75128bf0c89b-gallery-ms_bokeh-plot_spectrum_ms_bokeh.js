(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aaf8416c-30d3-4737-9cf0-845efc977ccf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aaf8416c-30d3-4737-9cf0-845efc977ccf' but no matching script tag was found.")
        }
