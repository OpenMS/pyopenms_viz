(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef9ac2e2-02a5-4823-8ff8-8379466f4321");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef9ac2e2-02a5-4823-8ff8-8379466f4321' but no matching script tag was found.")
        }
