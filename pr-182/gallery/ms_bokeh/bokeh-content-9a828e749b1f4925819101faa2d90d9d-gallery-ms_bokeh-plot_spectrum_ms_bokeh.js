(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c0df8cb3-d928-4684-85aa-ce5a67d8a6db");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c0df8cb3-d928-4684-85aa-ce5a67d8a6db' but no matching script tag was found.")
        }
