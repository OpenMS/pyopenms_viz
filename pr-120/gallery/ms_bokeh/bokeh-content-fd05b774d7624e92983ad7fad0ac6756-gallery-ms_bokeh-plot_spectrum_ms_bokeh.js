(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fb59d8e6-7fa5-4d4d-9478-5c9bdef7adef");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fb59d8e6-7fa5-4d4d-9478-5c9bdef7adef' but no matching script tag was found.")
        }
