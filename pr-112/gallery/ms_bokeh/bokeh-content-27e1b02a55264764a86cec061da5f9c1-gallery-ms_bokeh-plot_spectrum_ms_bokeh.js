(function() {
  const fn = function() {
    ...
    const element = document.getElementById("faaadf18-506d-4517-abe7-78dfabc5c4dc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'faaadf18-506d-4517-abe7-78dfabc5c4dc' but no matching script tag was found.")
        }
