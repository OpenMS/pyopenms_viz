(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b1c3cdeb-9e64-4058-9b5f-34a613cd4152");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b1c3cdeb-9e64-4058-9b5f-34a613cd4152' but no matching script tag was found.")
        }
