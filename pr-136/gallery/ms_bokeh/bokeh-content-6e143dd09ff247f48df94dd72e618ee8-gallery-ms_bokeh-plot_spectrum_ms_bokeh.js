(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dfa71c54-24a0-4b9f-9b85-8314218ffa17");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dfa71c54-24a0-4b9f-9b85-8314218ffa17' but no matching script tag was found.")
        }
