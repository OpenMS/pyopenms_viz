(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bbf801ac-db10-4114-9abc-e61669b5ba4d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bbf801ac-db10-4114-9abc-e61669b5ba4d' but no matching script tag was found.")
        }
