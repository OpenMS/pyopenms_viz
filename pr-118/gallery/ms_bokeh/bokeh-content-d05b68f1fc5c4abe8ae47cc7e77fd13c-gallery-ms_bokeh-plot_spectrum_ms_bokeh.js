(function() {
  const fn = function() {
    ...
    const element = document.getElementById("abbc0838-c671-4419-b45d-89d8eb2d08d4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'abbc0838-c671-4419-b45d-89d8eb2d08d4' but no matching script tag was found.")
        }
