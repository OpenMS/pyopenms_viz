(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c3e5b876-b1bd-4135-92dd-7541b76730e2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c3e5b876-b1bd-4135-92dd-7541b76730e2' but no matching script tag was found.")
        }
