(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b11ef4dc-60ce-47b4-8299-5d4f608de2fc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b11ef4dc-60ce-47b4-8299-5d4f608de2fc' but no matching script tag was found.")
        }
