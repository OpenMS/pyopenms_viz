(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d6dea82e-d169-49d7-af00-e08a946f042f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd6dea82e-d169-49d7-af00-e08a946f042f' but no matching script tag was found.")
        }
