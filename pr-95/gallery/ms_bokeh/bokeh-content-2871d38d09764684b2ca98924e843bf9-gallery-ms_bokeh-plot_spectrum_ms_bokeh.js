(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c8a40f84-1a5f-4285-8fcb-e41042bc666b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c8a40f84-1a5f-4285-8fcb-e41042bc666b' but no matching script tag was found.")
        }
