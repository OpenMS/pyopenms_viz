(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e59593e2-28af-4b8b-9561-4d748c7f0795");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e59593e2-28af-4b8b-9561-4d748c7f0795' but no matching script tag was found.")
        }
