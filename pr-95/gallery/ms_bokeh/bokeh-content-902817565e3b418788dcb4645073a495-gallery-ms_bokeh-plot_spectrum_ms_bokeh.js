(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f3a2b928-8a31-4bd2-9fce-93787e217c8e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3a2b928-8a31-4bd2-9fce-93787e217c8e' but no matching script tag was found.")
        }
