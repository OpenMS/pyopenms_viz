(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aff33a6b-cb51-4976-aebb-6131ff3f009c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aff33a6b-cb51-4976-aebb-6131ff3f009c' but no matching script tag was found.")
        }
