(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cbdf87cc-d81e-4add-82c3-38453cfc06e5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cbdf87cc-d81e-4add-82c3-38453cfc06e5' but no matching script tag was found.")
        }
