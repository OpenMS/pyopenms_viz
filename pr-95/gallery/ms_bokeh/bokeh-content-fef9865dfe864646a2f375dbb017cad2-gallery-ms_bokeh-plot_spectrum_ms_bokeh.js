(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e5839f71-ac6d-4542-bd06-70f96ecd6113");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e5839f71-ac6d-4542-bd06-70f96ecd6113' but no matching script tag was found.")
        }
