(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eba2d903-7857-49ea-bfd4-27dba92fd948");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eba2d903-7857-49ea-bfd4-27dba92fd948' but no matching script tag was found.")
        }
