(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf8259d4-308c-4573-9627-dad642f812cf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf8259d4-308c-4573-9627-dad642f812cf' but no matching script tag was found.")
        }
