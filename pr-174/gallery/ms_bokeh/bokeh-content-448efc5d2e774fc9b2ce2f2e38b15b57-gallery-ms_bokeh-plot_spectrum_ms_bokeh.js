(function() {
  const fn = function() {
    ...
    const element = document.getElementById("abdd3536-4ddc-4a6a-b914-425df96af10f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'abdd3536-4ddc-4a6a-b914-425df96af10f' but no matching script tag was found.")
        }
