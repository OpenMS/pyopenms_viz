(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4c4845c-3264-424a-89b2-0a621f18ea6b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4c4845c-3264-424a-89b2-0a621f18ea6b' but no matching script tag was found.")
        }
