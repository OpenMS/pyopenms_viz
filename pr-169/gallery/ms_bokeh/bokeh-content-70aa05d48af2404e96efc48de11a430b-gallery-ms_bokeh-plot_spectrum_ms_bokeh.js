(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c07ffe58-e48c-43ae-bbdc-32086976475d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c07ffe58-e48c-43ae-bbdc-32086976475d' but no matching script tag was found.")
        }
