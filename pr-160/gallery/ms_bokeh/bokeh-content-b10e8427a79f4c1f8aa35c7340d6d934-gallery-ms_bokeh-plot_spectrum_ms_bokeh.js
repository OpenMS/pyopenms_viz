(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bab3c3ab-9f2b-4408-b14f-c1adc12a8dd0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bab3c3ab-9f2b-4408-b14f-c1adc12a8dd0' but no matching script tag was found.")
        }
