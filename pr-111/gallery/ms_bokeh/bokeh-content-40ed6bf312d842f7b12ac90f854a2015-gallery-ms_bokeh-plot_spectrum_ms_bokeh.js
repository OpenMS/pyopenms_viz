(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e79286e7-ba0b-455c-864a-21e062389d7b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e79286e7-ba0b-455c-864a-21e062389d7b' but no matching script tag was found.")
        }
