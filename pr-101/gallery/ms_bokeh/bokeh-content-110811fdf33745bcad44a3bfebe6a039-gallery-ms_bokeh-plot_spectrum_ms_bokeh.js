(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bd69afa2-dc02-4253-b0c9-e26a25816e3d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bd69afa2-dc02-4253-b0c9-e26a25816e3d' but no matching script tag was found.")
        }
