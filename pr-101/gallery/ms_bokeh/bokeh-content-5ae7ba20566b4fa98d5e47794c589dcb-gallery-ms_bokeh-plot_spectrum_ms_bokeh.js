(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e597f2c7-9c54-4634-b154-6378bd542392");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e597f2c7-9c54-4634-b154-6378bd542392' but no matching script tag was found.")
        }
