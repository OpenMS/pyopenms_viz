(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f6a5d079-c699-45dd-b1b0-0d305fe74d37");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6a5d079-c699-45dd-b1b0-0d305fe74d37' but no matching script tag was found.")
        }
