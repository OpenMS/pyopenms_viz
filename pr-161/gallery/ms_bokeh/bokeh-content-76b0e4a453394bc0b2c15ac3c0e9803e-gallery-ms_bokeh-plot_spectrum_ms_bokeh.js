(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8816006-b017-4a4c-ba89-fccc9c348c54");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8816006-b017-4a4c-ba89-fccc9c348c54' but no matching script tag was found.")
        }
