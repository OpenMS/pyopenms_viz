(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cd99bfd0-b9db-4787-8a39-ed623517c59c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cd99bfd0-b9db-4787-8a39-ed623517c59c' but no matching script tag was found.")
        }
