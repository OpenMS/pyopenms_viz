(function() {
  const fn = function() {
    ...
    const element = document.getElementById("acb87c0e-f193-4524-a698-8767875562f8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'acb87c0e-f193-4524-a698-8767875562f8' but no matching script tag was found.")
        }
