(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ff60256c-a12b-4ae3-931c-830aba87c25c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ff60256c-a12b-4ae3-931c-830aba87c25c' but no matching script tag was found.")
        }
