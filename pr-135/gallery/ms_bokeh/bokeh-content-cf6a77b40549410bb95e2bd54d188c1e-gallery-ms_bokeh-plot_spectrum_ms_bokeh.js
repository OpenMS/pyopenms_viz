(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e609d9ba-cce0-446b-8fea-60948a98749a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e609d9ba-cce0-446b-8fea-60948a98749a' but no matching script tag was found.")
        }
