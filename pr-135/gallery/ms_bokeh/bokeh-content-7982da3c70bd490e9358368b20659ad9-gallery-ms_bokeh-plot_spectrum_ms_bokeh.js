(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a45bc169-17bd-46ed-99e2-57d5e1888aac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a45bc169-17bd-46ed-99e2-57d5e1888aac' but no matching script tag was found.")
        }
