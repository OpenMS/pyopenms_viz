(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de63a8e1-49ae-4eed-be04-912816de6116");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de63a8e1-49ae-4eed-be04-912816de6116' but no matching script tag was found.")
        }
