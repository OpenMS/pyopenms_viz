(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ba8930b1-adf7-469e-9080-cbca8aff639d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ba8930b1-adf7-469e-9080-cbca8aff639d' but no matching script tag was found.")
        }
