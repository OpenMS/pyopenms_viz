(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f05995a8-fd09-4271-8528-2906222b8b8a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f05995a8-fd09-4271-8528-2906222b8b8a' but no matching script tag was found.")
        }
