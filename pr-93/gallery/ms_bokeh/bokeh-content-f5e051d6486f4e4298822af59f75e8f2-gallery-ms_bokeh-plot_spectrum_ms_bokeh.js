(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a5ba23c3-6bcb-4578-a418-633ed598711b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a5ba23c3-6bcb-4578-a418-633ed598711b' but no matching script tag was found.")
        }
