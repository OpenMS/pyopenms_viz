(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d2ce61d8-aead-4d80-944e-557a8b45779c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2ce61d8-aead-4d80-944e-557a8b45779c' but no matching script tag was found.")
        }
