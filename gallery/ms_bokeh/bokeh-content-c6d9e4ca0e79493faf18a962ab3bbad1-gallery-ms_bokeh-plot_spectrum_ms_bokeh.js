(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db193a60-1d42-42a9-86a0-9e56af5a7869");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db193a60-1d42-42a9-86a0-9e56af5a7869' but no matching script tag was found.")
        }
