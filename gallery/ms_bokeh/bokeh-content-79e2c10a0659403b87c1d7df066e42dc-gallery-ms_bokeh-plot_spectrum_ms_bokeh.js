(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af862fed-bc6d-491f-9eb0-50649b07e4b2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af862fed-bc6d-491f-9eb0-50649b07e4b2' but no matching script tag was found.")
        }
