(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4bffc5b-9245-4e30-b661-4a4df9969152");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4bffc5b-9245-4e30-b661-4a4df9969152' but no matching script tag was found.")
        }
