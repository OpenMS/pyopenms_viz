(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c687c730-7785-4983-a255-995968600f60");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c687c730-7785-4983-a255-995968600f60' but no matching script tag was found.")
        }
